  ...
  definePinchZoom = function () {
    ...
    d.prototype = {
      ...
      sanitizeOffset: function (c) {
        ...
        return { x: a(b(c.x, j), h), y: a(b(c.y, k), i) };
      },
            ...
            function () {
              ...
              !this.options.use2d || this.hasInteraction || this.inAnimation
                ? ((this.is3d = !0),
                  ...
                  (this.el.style.mozTransform = f),
                  (this.el.style.msTransform = f),
                  (this.el.style.oTransform = f),
                ...
                : (this.is3d &&
                  ...
                  (this.el.style.webkitTransform = f),
                  (this.el.style.mozTransform = f),
                  (this.el.style.msTransform = f),
                  (this.el.style.oTransform = f),
                  (this.el.style.transform = f),
                  (this.is3d = !1));
            }.bind(this),
            0
          ));
